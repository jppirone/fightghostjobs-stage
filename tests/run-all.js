...
const steps = [
  ["unit + API tests", [path.join(here, "unit.test.js"), path.join(here, "api.test.js"), path.join(here, "locations.test.js"), path.join(here, "dashboard.test.js"), path.join(here, "edit.test.js")], true],
